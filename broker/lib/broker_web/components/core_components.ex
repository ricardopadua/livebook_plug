defmodule BrokerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BrokerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BrokerWeb.Gettext, "errors", msg, opts)
    end
  end
